...
module.exports = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'release_12.0.0-test2',
      content: '<a href="/versions/12.0.0?utm_source=docs-banner&utm_campaign=12.0.0-banner">ProtonAOSP 12.0.0 is now available in early access!</a>',
    },
    algolia: {
